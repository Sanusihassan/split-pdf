...
import { SplitPDFHOWTO_ar } from "@/src/how-to";
...
export default ({ item, lang, initialPremiumStatus }: { item: _tool["Split_PDF"]; lang: string; initialPremiumStatus: boolean; }) => {
    ...
    <>
      <Head>
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(SplitPDFHOWTO_ar),
          }}
        />
