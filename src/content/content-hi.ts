...
export const tool: _tool = {
  Split_PDF: {
    ...
    seoTitle: "ऑनलाइन पीडीएफ विभाजित करें - सुरक्षित रूप से पीडीएफ को कई दस्तावेजों में विभाजित करें",
    description: "एक पीडीएफ फाइल को कई दस्तावेजों में विभाजित करें",
    color: "var(--orange)",
    type: ".pdf",
    to: "/split-pdf",
    keywords: "पीडीएफ विभाजित करें, पीडीएफ फाइल विभाजित करें, पीडीएफ विभाजक, पीडीएफ पेज निकालें, ऑनलाइन पीडीएफ टूल",
    features: [
      {
        title: "सटीक पृष्ठ विभाजन",
        description: "अपनी पीडीएफ को व्यक्तिगत पृष्ठों या पृष्ठों की श्रेणी में विभाजित करें, मूल दस्तावेज़ की अखंडता को बनाए रखते हुए।"
      },
      {
        title: "तेज और कुशल",
        description: "तेजी से प्रोसेसिंग समय का अनुभव करें, जिससे आप केवल कुछ ही सेकंड में अपने पीडीएफ दस्तावेजों को विभाजित कर सकें।"
      },
      {
        title: "सुरक्षित और निजी",
        description: "हमारा टूल आपके फ़ाइलों को सुरक्षित रूप से संभालने की गारंटी देता है, विभाजन प्रक्रिया के दौरान आपके डेटा की सुरक्षा करता है।"
      }
    ]
  }
};
