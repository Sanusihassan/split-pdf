...
export const tool: _tool = {
  Split_PDF: {
    ...
    seoTitle:
      "PDF विभाजित करें ऑनलाइन - एक PDF फ़ाइल को विभिन्न दस्तावेज़ों में विभाजित करें | PDFEquips",
    description: "एक PDF फ़ाइल को विभिन्न दस्तावेज़ों में विभाजित करें",
    color: "var(--orange)",
    type: ".pdf",
    to: "/split-pdf",
  },
